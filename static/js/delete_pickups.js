...
document.getElementById("delete_btn").addEventListener("click", function (e) {
    ...
    const selectedIds = Array.from(document.querySelectorAll("#pickup_table .checkbox:checked"))
            ...
            fetch('/generators/delete/', {
                ...
                .then((data) => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: "Deleted!",
                            text: "The selected Pickup have been deleted.",
                            icon: "success",
                            confirmButtonText: 'OK'
                        });
                    } else {
