...
document.getElementById("delete_btn").addEventListener("click", function (e) {
    ...
    const selectedIds = Array.from(document.querySelectorAll("#agreement_table .checkbox:checked"))
            ...
            fetch('/agreements/delete/', {
                ...
                .then((data) => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: "Deleted!",
                            text: "The selected Agreement have been deleted.",
                            icon: "success",
                            confirmButtonText: 'OK'
                        });
                    } else {
