...
document.getElementById("delete_btn").addEventListener("click", function (e) {
    ...
    const selectedIds = Array.from(document.querySelectorAll("#collector-table .checkbox:checked"))
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('/collectors/delete/', {
                    ...
                    body: JSON.stringify({
                        waste_collector_ids: selectedIds
                    })
                })
                .then((res) => res.json())
                .then((data) => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: "Deleted!",
                            text: "The selected waste Collector have been deleted.",
                            icon: "success",
                            confirmButtonText: 'OK'
                        });
                    } else {
